                 ...
                 tabsetPanel(
                   ...
                   tabPanel("Summary",
                            ...
                            tags$p("The population of bees is affected by various factors. And temperature is one of them. Too high? 
                                   Bees ability to learn is hinder. Too low? Bees develop abnormal flying habit.
                            ...
                            tags$p("For the time graphs, the year is on the x-axis and the temperature in Celsius is on the y-axis.
                                   ...
                                   temperatures for most bees can to operate normally . Which is around 34 Celsius to 13
                                   Celsius. The graph is expected to show what State’s change in maximum and minimum temperature 
                                   that might poses to be a threat to bee colonies."))
                 )
               )
             )
    ),
             ...
             sidebarLayout(   # layout the page in two columns
               ...
               mainPanel( 
                 tabsetPanel(
                   ...
                   tabPanel("Summary",
                            tags$br(),
                            tags$p("Why might pollution impact number of honeybee colonies? A study found on ScienceDaily 
                                    (https://www.sciencedaily.com/releases/2016/07/160706131924.htm) claims that “Bees' 
                                    ability to forage decreases as air pollution increases”. The study explains that pollution
